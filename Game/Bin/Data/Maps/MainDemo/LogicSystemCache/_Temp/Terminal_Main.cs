...
namespace Maps_MainDemo_LogicSystem_LogicSystemScripts
{
	public class Terminal_Main : Engine.EntitySystem.LogicSystem.LogicEntityObject
	{
		...
		public Engine.UISystem.TabControl tabControl;
		public Engine.UISystem.Button previousButton;
		public Engine.UISystem.Button nextButton;
		public Engine.UISystem.TextBox currentPageText;
		...
		public void Next_Click( Engine.UISystem.Button sender )
		{
			Engine.EntitySystem.LogicClass __class = Engine.EntitySystem.LogicSystemManager.Instance.MapClassManager.GetByName( "Terminal_Main" );
		...
		public void Previous_Click( Engine.UISystem.Button sender )
		{
			Engine.EntitySystem.LogicClass __class = Engine.EntitySystem.LogicSystemManager.Instance.MapClassManager.GetByName( "Terminal_Main" );
		...
		public void Camera_Click( Engine.UISystem.Button sender )
		{
			Engine.EntitySystem.LogicClass __class = Engine.EntitySystem.LogicSystemManager.Instance.MapClassManager.GetByName( "Terminal_Main" );
		...
		public void CameraOptionsClose_Click( Engine.UISystem.Button sender )
		{
			Engine.EntitySystem.LogicClass __class = Engine.EntitySystem.LogicSystemManager.Instance.MapClassManager.GetByName( "Terminal_Main" );
