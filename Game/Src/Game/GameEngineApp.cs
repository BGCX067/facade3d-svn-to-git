...
namespace Game
{
	...
	public class GameEngineApp : EngineApp
	{
		...
		protected override bool OnCreate()
		{
			...
			//showEngineProfiler console command
			if( EngineConsole.Instance != null )
				EngineConsole.Instance.AddCommand( "showEngineProfiler", ConsoleCommand_ShowEngineProfiler );
		...
		protected override bool OnKeyDown( KeyEvent e )
		{
			...
			{
				bool show = EngineProfilerWindow.Instance == null;
				ShowEngineProfiler( show );
				return true;
			}
		...
		{
			if( needMapLoadName != null || needMapCreateForDynamicMapExample || needWorldLoadName != null )
				return true;
		...
		protected override void OnTick( float delta )
		{
			...
			if( needMapLoadName != null || needMapCreateForDynamicMapExample || needWorldLoadName != null )
			{
				...
				if( fadingOutTimer == 0 )
				{
					...
					else if( needMapCreateForDynamicMapExample )
					{
			...
			WorldType worldType, string mapVirtualFileName )
		{
			...
			//show map loading window
			Control mapLoadingWindow = ControlDeclarationManager.Instance.CreateControl(
				"Gui\\MapLoadingWindow.gui" );
			if( mapLoadingWindow != null )
			{
		...
		static void ConsoleCommand_ShowEngineProfiler( string arguments )
		{
			bool show = EngineProfilerWindow.Instance == null;
