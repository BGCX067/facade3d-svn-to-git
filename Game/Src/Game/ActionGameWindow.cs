...
namespace Game
{
	...
	public class ActionGameWindow : GameWindow
	{
		...
		protected override void OnMouseMove()
		{
			...
			//ignore mouse move events if engine profiler enabled and background mode is disabled.
			if( EngineProfilerWindow.Instance != null && !EngineProfilerWindow.Instance.Background )
				return;
