...
namespace GameEntities
{
    ...
    /// </summary>
    public class MenuTileType : MapObjectType
    {
    }
    ...
    /// </summary>
    public class MenuTile : MapObject
    {
        ...
        MenuTileType _type = null; public new MenuTileType Type { get { return _type; } }
        ...
        void CreateMesh()
        {
            ...
            string meshName = MeshManager.Instance.GetUniqueName(
                string.Format("MenuTile[{0},{1}]", index.X, index.Y));
        ...
        void Server_SendIndexToClients(IList<RemoteEntityWorld> remoteEntityWorlds)
        {
            SendDataWriter writer = BeginNetworkMessage(remoteEntityWorlds,
                typeof(MenuTile), (ushort)NetworkMessages.IndexToClient);
            writer.Write(Index);
            EndNetworkMessage();
        }
        ...
        {
            SendDataWriter writer = BeginNetworkMessage(remoteEntityWorlds,
                typeof(MenuTile), (ushort)NetworkMessages.PositionToClient);
        ...
        {
            if (serverOrSingle_Moving)
                Log.Fatal("MenuTile: Server_BeginMoving: serverOrSingle_Moving == true.");
            ...
            SendDataWriter writer = BeginNetworkMessage(typeof(MenuTile),
        ...
        public void ServerOrSingle_MoveFinish()
        {
            ...
            bool completePuzzle = true;
            {
                ...
                {
                    MenuTile piece = entity as MenuTile;
                    if (piece != null)
                    {
