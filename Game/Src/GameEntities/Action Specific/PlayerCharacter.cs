...
namespace GameEntities
{
	...
	public class PlayerCharacter : GameCharacter
	{
		...
		protected override void OnRender( Camera camera )
		{
            ...
            fpsCamera = false;
            playerIntellectFPSCamera = false;

			bool mainCameraUpdating =
				SceneManager.Instance.CurrentUpdatingCamera.Purpose == Camera.Purposes.MainCamera;


			if( activeWeapon != null && GameMap.Instance.GameType != GameMap.GameTypes.TPSArcade )
			{
				//FPS mesh material
				activeWeapon.FPSMeshMaterialNameEnabled = fpsCamera;
